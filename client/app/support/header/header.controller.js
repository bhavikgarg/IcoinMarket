...
angular.module('iCoinApp')
    .controller('SupportHeaderCtrl', function($scope, User, Auth, Utilities, $rootScope, $cookies, AdminAccess, $cookieStore, $sce, ApiPath, $uibModal, $uibModalStack,ConfigurationService, $state) {
